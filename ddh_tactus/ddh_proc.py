...
# -- Files list
dir1 = '/ec/res4/scratch/swe7088/deode/ddh_mat_CY49t2_HARMONIE_AROME_LES_input_Paris_200m_linear_20230820/archive/2023/08/20/12/mbr000/'
file_list = glob.glob(dir1+'DHFDLDEOD+*s')
file_list.sort()
file_list = file_list
file1 = file_list[0]
...
if __name__ == "__main__":
    ...
    # Create bag, map the function, and compute
    # npartitions should be balanced; ~100 files per partition is usually healthy
    b = db.from_sequence(file_list, npartitions=12)
    datasets = b.map(proc_one_file).compute()

    # 5. Concatenate all datasets along the time dimension
